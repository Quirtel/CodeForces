...
final class RanklistRowObject: Object {
    ...
    @objc dynamic var problemResults: [ProblemResult] = []
...
extension RanklistRow: RealmRepresentable {
    var realmObject: RanklistRowObject {
        ...
        ranklistRow.lastSubmissionTimeSeconds.value = lastSubmissionTimeSeconds
        return ranklistRow
    }
}
extension RanklistRowObject: StructRepresentable {
    var `struct`: RanklistRow {
        return RanklistRow(party: party, rank: rank, points: points, penalty: penalty, successfulHackCount: successfulHackCount, unsuccessfulHackCount: unsuccessfulHackCount, problemResults: problemResults, lastSubmissionTimeSeconds: lastSubmissionTimeSeconds.value)
    }
}
